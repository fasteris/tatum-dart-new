...
class _XinFinAPI implements XinFinAPI {
  _XinFinAPI(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<GenerateXinfinWallet> generateWallet({String? mnemonic}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'mnemonic': mnemonic};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GenerateXinfinWallet>(
    ...
    late GenerateXinfinWallet _value;
    try {
      _value = GenerateXinfinWallet.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<GetXinFinBlockByHashResponse> getXinFinBlockByHash({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetXinFinBlockByHashResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'xdc/block/${hash}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetXinFinBlockByHashResponse _value;
    try {
      _value = GetXinFinBlockByHashResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<dynamic> getXinFinTransaction({required String hash}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<int> countOutgoingXinFinTransaction({required String address}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
