...
part 'get_kucoin_block_by_hash.g.dart';

@JsonSerializable()
class GetKuCoinBlockByHashResponse {
  ...
  factory GetKuCoinBlockByHashResponse.fromJson(Map<String, dynamic>? json) =>
      _$GetKuCoinBlockByHashResponseFromJson(json!);

  Map<String, dynamic> toJson() => _$GetKuCoinBlockByHashResponseToJson(this);
}
