...
class _KuCoinAPI implements KuCoinAPI {
  _KuCoinAPI(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<GenerateKuCoinWallet> generateWallet({String? mnemonic}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'mnemonic': mnemonic};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GenerateKuCoinWallet>(
    ...
    late GenerateKuCoinWallet _value;
    try {
      _value = GenerateKuCoinWallet.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<GetKuCoinBlockByHashResponse> getKuCoinBlockByHash({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetKuCoinBlockByHashResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'kcs/block/${hash}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetKuCoinBlockByHashResponse _value;
    try {
      _value = GetKuCoinBlockByHashResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<TransactionEntity> getKuCoinTransaction({required String hash}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<int> countOutgoingKuCoinTransaction({required String address}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
