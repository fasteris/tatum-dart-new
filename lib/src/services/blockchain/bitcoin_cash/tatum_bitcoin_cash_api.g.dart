...
class _BitcoinCashAPI implements BitcoinCashAPI {
  _BitcoinCashAPI(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<GenerateBCashWalletResponse> generateWallet() async {
    ...
    final _options = _setStreamType<GenerateBCashWalletResponse>(
    ...
    late GenerateBCashWalletResponse _value;
    try {
      _value = GenerateBCashWalletResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<GetBCashBlockByHashResponse> getBCashBlockByHash({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetBCashBlockByHashResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'bcash/block/${hash}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetBCashBlockByHashResponse _value;
    try {
      _value = GetBCashBlockByHashResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<GetBCashTransactionResponse> getBCashTransactionByHash({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetBCashTransactionResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetBCashTransactionResponse _value;
    try {
      _value = GetBCashTransactionResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<SendAlgoResponse> sendBCH({required SendUTXOModel body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
