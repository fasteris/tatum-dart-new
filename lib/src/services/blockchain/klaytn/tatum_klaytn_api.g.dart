...
class _KlaytnAPI implements KlaytnAPI {
  ...
  @override
  Future<GenerateKlayWallet> generateWallet({mnemonic}) async {
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<GenerateKlayWallet>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = GenerateKlayWallet.fromJson(_result.data!);
    return value;
  }
  ...
  Future<GetKlayBlockByHashResponse> getKlaytnBlockByHash(
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<GetKlayBlockByHashResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            ...
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = GetKlayBlockByHashResponse.fromJson(_result.data!);
    return value;
  }
  ...
  @override
  Future<TransactionEntity> getKlaytnTransaction({required hash}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<int> countOutgoingKlaytnTransaction({required address}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
