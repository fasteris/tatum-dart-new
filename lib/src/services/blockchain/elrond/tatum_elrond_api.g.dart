...
class _ElrondAPI implements ElrondAPI {
  _ElrondAPI(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<ElrondMnemonicResponse> generateWallet({String? mnemonic}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'mnemonic': mnemonic};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ElrondMnemonicResponse>(
    ...
    late ElrondMnemonicResponse _value;
    try {
      _value = ElrondMnemonicResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<EGLDBlockByHashResponse> getEgldBlockByHash({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<EGLDBlockByHashResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'egld/block/${hash}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late EGLDBlockByHashResponse _value;
    try {
      _value = EGLDBlockByHashResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<AccountBalanceResponse> getEgldAccountBalance({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AccountBalanceResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<EgldTransactionEntity> getEgldTransaction({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<EgldTransactionEntity>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late EgldTransactionEntity _value;
    try {
      _value = EgldTransactionEntity.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<int> countOutgoingEgldTransaction({required String address}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<TXIDResponse> send({required SendElrondModel body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<TXIDResponse> broadcast({required BroadcastModel body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
