...
class _VeChainAPI implements VeChainAPI {
  _VeChainAPI(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<GenerateVeChainWallet> generateWallet({String? mnemonic}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'mnemonic': mnemonic};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GenerateVeChainWallet>(
    ...
    late GenerateVeChainWallet _value;
    try {
      _value = GenerateVeChainWallet.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<GetVeChainBlockByHashResponse> getVeChainBlockByHash({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetVeChainBlockByHashResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'vet/block/${hash}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetVeChainBlockByHashResponse _value;
    try {
      _value = GetVeChainBlockByHashResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<EnergyResponse> getVeChainAccountEnergy({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<EnergyResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late EnergyResponse _value;
    try {
      _value = EnergyResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<dynamic> getVeChainTransaction({required String hash}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<dynamic> getVeChainTransactionReceipt({required String hash}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<TXIDResponse> sendVeChain({required SendVeChainModel body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
