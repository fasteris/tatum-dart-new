...
class _BSCAPI implements BSCAPI {
  _BSCAPI(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<GenerateBSCWallet> generateWallet() async {
    ...
    final _options = _setStreamType<GenerateBSCWallet>(
    ...
    late GenerateBSCWallet _value;
    try {
      _value = GenerateBSCWallet.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<int> countOutgoingBSCTransaction({required String address}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<SendAlgoResponse> send({required SendModel body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
