...
class _DogeCoinAPI implements DogeCoinAPI {
  _DogeCoinAPI(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<GenerateDogecoinWallet> generateWallet({String? mnemonic}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'mnemonic': mnemonic};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GenerateDogecoinWallet>(
    ...
    late GenerateDogecoinWallet _value;
    try {
      _value = GenerateDogecoinWallet.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<GetDogecoinBlockByHashResponse> getDogecoinBlockByHash({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetDogecoinBlockByHashResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'dogecoin/block/${hash}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetDogecoinBlockByHashResponse _value;
    try {
      _value = GetDogecoinBlockByHashResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<DogecoinTransactionResponse> getDogecoinTransactionByHash({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<DogecoinTransactionResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DogecoinTransactionResponse _value;
    try {
      _value = DogecoinTransactionResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<TXIDResponse> sendDogecoin({required SendDogecoinModel body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
