...
class _PolygonAPI implements PolygonAPI {
  ...
  @override
  Future<GeneratePolygonWallet> generateWallet({mnemonic}) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<GeneratePolygonWallet>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = GeneratePolygonWallet.fromJson(_result.data!);
    return value;
  }
  ...
  Future<GetPolygonBlockByHashResponse> getPolygonBlockByHash(
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<GetPolygonBlockByHashResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            ...
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = GetPolygonBlockByHashResponse.fromJson(_result.data!);
    return value;
  }
  ...
  @override
  Future<TransactionEntity> getPolygonTransaction({required hash}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<int> countOutgoingPolygonTransaction({required address}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<List<TransactionEntity>> getPolygonTransactionByAddress({
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<TransactionEntity>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
