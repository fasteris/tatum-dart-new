...
part of 'tatum_polygon_api.dart';
...
class _PolygonAPI implements PolygonAPI {
  _PolygonAPI(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<GeneratePolygonWallet> generateWallet({String? mnemonic}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'mnemonic': mnemonic};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GeneratePolygonWallet>(
    ...
    late GeneratePolygonWallet _value;
    try {
      _value = GeneratePolygonWallet.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<GetPolygonBlockByHashResponse> getPolygonBlockByHash({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetPolygonBlockByHashResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'polygon/block/${hash}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetPolygonBlockByHashResponse _value;
    try {
      _value = GetPolygonBlockByHashResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<AccountBalanceResponse> getPolygonAccountBalance({
    ...
    final _options = _setStreamType<AccountBalanceResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'polygon/account/balance/${address}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  @override
  Future<int> countOutgoingPolygonTransaction({required String address}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<int>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'polygon/transaction/count/${address}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<List<TransactionEntity>> getPolygonTransactionByAddress({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<TransactionEntity>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'polygon/account/transaction/${address}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    late List<TransactionEntity> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                TransactionEntity.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
  ...
  @override
  Future<TXIDResponse> send({required SendModel body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
