...
class _EthereumAPI implements EthereumAPI {
  _EthereumAPI(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<GenerateEthereumWallet> generateWallet({String? mnemonic}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'mnemonic': mnemonic};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GenerateEthereumWallet>(
    ...
    late GenerateEthereumWallet _value;
    try {
      _value = GenerateEthereumWallet.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<GetEthereumBlockByHashResponse> getEthereumBlockByHash({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetEthereumBlockByHashResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'ethereum/block/${hash}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetEthereumBlockByHashResponse _value;
    try {
      _value = GetEthereumBlockByHashResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<GetEthereumTrByAddressResponse> getEthereumTransactionByAddress({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetEthereumTrByAddressResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetEthereumTrByAddressResponse _value;
    try {
      _value = GetEthereumTrByAddressResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<TXIDResponse> send({required SendEthModel body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<List<InternalTransactionEntity>>
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<InternalTransactionEntity>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    late List<InternalTransactionEntity> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) => InternalTransactionEntity.fromJson(
