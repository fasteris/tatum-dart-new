...
class _LitecoinAPI implements LitecoinAPI {
  _LitecoinAPI(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<GenerateLitecoinWallet> generateWallet({String? mnemonic}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'mnemonic': mnemonic};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GenerateLitecoinWallet>(
    ...
    late GenerateLitecoinWallet _value;
    try {
      _value = GenerateLitecoinWallet.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<GetLitecoinBlockByHashResponse> getLitecoinBlockByHash({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetLitecoinBlockByHashResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'litecoin/block/${hash}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetLitecoinBlockByHashResponse _value;
    try {
      _value = GetLitecoinBlockByHashResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<LitecoinTransactionResponse> getLitecoinTransactionByHash({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<LitecoinTransactionResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late LitecoinTransactionResponse _value;
    try {
      _value = LitecoinTransactionResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<TXIDResponse> sendLitecoin({required SendLitecoinModel body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
