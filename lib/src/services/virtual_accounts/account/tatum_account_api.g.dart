...
class _VirtualAccountAPI implements VirtualAccountAPI {
  _VirtualAccountAPI(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<CreateAccountResponse> createAccount({
    required CreateAccountModel body,
  }) async {
    ...
    final _options = _setStreamType<CreateAccountResponse>(
  ...
  Future<List<CreateAccountResponse>> listAllAccounts({
    ...
    final _options = _setStreamType<List<CreateAccountResponse>>(
    ...
    late List<CreateAccountResponse> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
  ...
  Future<List<CreateAccountResponse>> createMultipleAccountsInBatchCall({
    required CreateAccountBatchModel body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<dynamic> updateAccountById({
    required String id,
    required UpdateAccountModel body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<CreateAccountResponse> getAccountBalance({required String id}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<dynamic> blockAmountInAnAccount({
    required String id,
    required BlockAmountInAnAccount body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<dynamic> unblockAmountInAnAccountToPerformTrns({
    required String id,
    required UnBlockAmountInAnAccount body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<dynamic> unblockABlockedAmountInAccount({required String id}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<List<AmountEntity>> getBlockedAmountsInAccount({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<AmountEntity>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'ledger/account/block/${id}',
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<AmountEntity> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) => AmountEntity.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
  ...
  @override
  Future<AmountEntity> getBlockedAmountById({required String id}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AmountEntity>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AmountEntity _value;
    try {
      _value = AmountEntity.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<dynamic> activateAnAccount(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<dynamic> deativateAccount(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<dynamic> freezeAccount(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<dynamic> unfreezeAccount(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
